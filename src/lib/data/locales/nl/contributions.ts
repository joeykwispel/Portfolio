...
export const contributions: Record<string, ContributionText> = {
  'minvws-dvp-proxy-8': {
    ...
    about: 'Een Python-proxy van het ministerie die een JWT ondertekent om zich tijdens het inloggen te authenticeren bij een OIDC-tokenendpoint (private_key_jwt, RFC 7523).',
  ...
  'fundament-424': {
    ...
    about: 'Een Go-project met een Kubernetes-operator voor OpenFSC, waarmee organisaties services met elkaar federeren. De groeps-CA is een echte productie-trustroot.',
  ...
  'brp-amsterdam-195': {
    ...
    about: 'Een autorisatieproxy tussen de diensten van de gemeente en de Basisregistratie Personen (BRP) bij RvIG, voor burgerservicenummers (BSN) en adresgegevens.',

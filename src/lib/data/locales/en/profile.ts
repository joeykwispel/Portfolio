export const profile = {
  ...
  facts: [
    ...
    { label: 'Employer', value: 'Competa IT, assigned to client projects' },
    { label: 'Front-end focus', value: 'Angular, React, Next.js, Vue.js, TypeScript' },
    { label: 'Back-end and infra', value: 'NestJS, Python, FastAPI, Kubernetes, Proxmox' },
    { label: 'Sectors', value: 'Public sector, real estate, media, e-health' }
  ]
};

...
export const cv: Record<'en' | 'nl', Cv> = {
  "en": {
    ...
    "skills": [
      {
        "label": "Front-End",
        "items": "Angular, Angular Material, React, Vue.js, Next.js, Nuxt, Ionic Framework, TypeScript, JavaScript (ES6), RxJS, XML, Web Components, jQuery, HTML5, Semantic HTML5, CSS3, SASS, SCSS, Styled Components, Tailwind CSS"
      },
      {
        "label": "Back-End",
      ...
      },
      {
        ...
        "items": "Model Context Protocol (MCP), Capacitor, Postman, Sentry, Jira, Trello, Monday, Miro, Figma, WordPress, HubSpot, Visual Studio Code, PhpStorm, JetBrains, NPM, PNPM, Yarn, Vite, ESLint, Prettier, SEO, Windows, Linux, macOS, iOS, Android"
      },
      {
    ...
    "projects": [
      ...
      },
      {
        ...
        "stack": "Angular, Ionic Framework, Capacitor, Angular Material, RxJS, TypeScript, JavaScript (ES6), HTML5, SCSS, CSS3, REST APIs, JSON, Playwright MCP, Jest, Vitest, Git, Azure DevOps, Docker, npm, ESLint, Prettier, Agile, Scrum"
      },
      {
        "client": "Red Ocelot (via Competa IT)",
        "summary": "As Lead Developer, Joey was responsible for the development of Code Tuner, a greenfield SaaS platform that helps organizations gain insight into and reduce technical debt across complex software landscapes. He provided technical leadership to the development team, was responsible for both front-end and back-end development, and also fulfilled the role of Scrum Master.",
        "bullets": [
        ...
        "stack": "React, Next.js, Web Components, D3.js, Chart.js, TypeScript, JavaScript (ES6), HTML, SCSS, CSS, Sass, NestJS, Hono, Python, Prisma, PostgreSQL, REST Services, JSON, Jest, Vitest, React Testing Library, Stryker, Git, GitHub, GitLab, GitHub Actions, Docker, Sentry, Trello, CI/CD, Microservices, Agile, Scrum, SAFe, WCAG 2.1"
      },
      {
        "client": "ParaMedia (via Competa IT)",
        "summary": "Joey contributed to the continued development of MediumChat, a communication platform for healthcare professionals. As part of the development team, he was responsible for implementing new front-end functionality and contributed to the further development of the underlying APIs and integrations.",
        "bullets": [
      ...
      },
      {
        ...
        "summary": "Joey contributed to the development of a platform for managing and publishing content across social media channels. Working within an Agile Scrum team, he developed reusable React components and templates that could be used by multiple editorial teams.",
        "bullets": [
      ...
      },
      {
        ...
        "summary": "At JEX, Joey contributed to the further development of the corporate website within the HubSpot CMS, with a strong focus on pixel-perfect implementation, performance, and user experience.",
        "bullets": [
      ...
      },
      {
        ...
        "summary": "Joey contributed to the development of a healthcare platform that connects pharmacies with patients. Using Vue.js, he developed accessible and user-friendly front-end functionality with a strong emphasis on delivering an optimal user experience.",
        "bullets": [],
        "role": "Front-end Developer",
      ...
      },
      {
        ...
        "summary": "Joey worked on internal systems and applications using PHP and Laravel. He integrated the Google Maps API and developed a scheduling system for selecting available time slots.",
        "bullets": [],
        "role": "Software Developer",
  ...
  "nl": {
    ...
    "skills": [
      {
        "label": "Front-end",
        "items": "Angular, Angular Material, React, Vue.js, Next.js, Nuxt, Ionic Framework, TypeScript, JavaScript (ES6), RxJS, XML, Web Components, jQuery, HTML5, Semantic HTML5, CSS3, SASS, SCSS, Styled Components, Tailwind CSS, Shadcn, I18N"
      },
      {
        "label": "Back-end",
        "items": "PHP, Laravel, Symfony, Zend, NestJS, Python, FastAPI, Hono, Pydantic, Prisma, SQL, MySQL, PostgreSQL, SQLite, RESTful APIs, OpenAPI, Swagger, JSON, YAML, XML, XPath, JWT"
      },
      {
        "label": "DevOps & CI/CD",
        "items": "Docker, Kubernetes, Proxmox, Nginx, Git, GitHub, GitLab, Azure DevOps, GitHub Actions, CI/CD pipelines, Bash, Shell, Command Line, Microservices"
      },
      {
        "label": "Testing",
      ...
      {
        "label": "Platforms & Tools",
        "items": "Model Context Protocol (MCP), Capacitor, Postman, Sentry, Jira, Trello, Monday, Miro, Figma, WordPress, HubSpot, Visual Studio Code, PHPStorm, JetBrains, NPM, PNPM, Yarn, Turborepo, Vite, ESLint, Prettier, SEO, Windows, Linux, macOS, iOS, Android"
      },
      {
    ...
    "projects": [
      {
        "client": "PQNavigator - Rijksdienst voor Ondernemend Nederland (RVO) (via Competa IT)",
        "summary": "Als Senior Front-end & Fullstack Developer draagt Joey bij aan de ontwikkeling van PQNavigator, een static-analysis platform dat source repositories scant om een cryptografische inventaris op te bouwen en de gereedheid voor post-quantum cryptografie te beoordelen. Zijn werkzaamheden richten zich op de gebruikersapplicatie, end-to-end applicatieflows, server-side integraties en de infrastructuur die nodig is om het platform betrouwbaar te draaien en uit te rollen.",
        "bullets": [
      ...
      },
      {
        ...
        "stack": "Angular, Ionic Framework, Capacitor, Angular Material, RxJS, TypeScript, JavaScript (ES6), HTML5, SCSS, CSS3, REST API's, JSON, Playwright MCP, Jest, Vitest, Git, Azure DevOps, Docker, npm, ESLint, Prettier, Agile, Scrum"
      },
      {
        "client": "Red Ocelot (via Competa IT)",
        "summary": "Als Lead Developer was Joey verantwoordelijk voor de ontwikkeling van Code Tuner, een greenfield SaaS-platform dat organisaties helpt technical debt binnen complexe softwarelandschappen inzichtelijk te maken en te verminderen. Hij gaf technisch leiding aan het ontwikkelteam, was verantwoordelijk voor zowel front-end als back-end ontwikkeling en vervulde daarnaast de rol van Scrum Master.",
        "bullets": [
      ...
      {
        "client": "ParaMedia (via Competa IT)",
        "summary": "Joey werkte aan de doorontwikkeling van MediumChat, een communicatieplatform voor zorgprofessionals. Binnen het ontwikkelteam was hij verantwoordelijk voor nieuwe front-end functionaliteiten en droeg hij bij aan de doorontwikkeling van onderliggende API’s en koppelingen.",
        "bullets": [
      ...
      {
        "client": "Vice Media (via Competa IT)",
        "summary": "Joey werkte aan de ontwikkeling van een platform voor het beheren en publiceren van content voor socialmediakanalen. Binnen een Agile Scrum-team ontwikkelde hij herbruikbare React-componenten en templates die door verschillende redactieteams konden worden ingezet.",
        "bullets": [
      ...
      {
        "client": "JEX (via Competa IT)",
        "summary": "Bij JEX werkte Joey aan de doorontwikkeling van de corporate website binnen het HubSpot CMS, met de nadruk op pixel-perfecte implementatie, performance en gebruikerservaring.",
        "bullets": [
      ...
      {
        "client": "EHVG ehealth venture group",
        "summary": "Joey droeg bij aan de ontwikkeling van een zorgplatform dat apotheken met patiënten verbindt. Met Vue.js realiseerde hij toegankelijke en gebruiksvriendelijke front-end functionaliteiten, waarbij de nadruk lag op een optimale gebruikerservaring.",
        "bullets": [],
        "role": "Front-end Developer",
      ...
      {
        "client": "Cruisereizen (intern)",
        "summary": "Joey werkte aan interne systemen en applicaties met PHP en Laravel. Hij integreerde de Google Maps API en ontwikkelde een planningssysteem voor het selecteren van tijdsloten.",
        "bullets": [],
        "role": "Software Developer",
